import"./main-DtEDl7Xs.js";/* empty css                   */const i=[{id:1,fecha:"2024-09-13",estado:"Pagado",productos:[{nombre:"Vestido de seda",cantidad:1,precio:25e4},{nombre:"Bolso de cuero",cantidad:1,precio:18e4}],reciboFoto:null},{id:2,fecha:"2024-09-15",estado:"Pendiente",productos:[{nombre:"Zapatos de tacón",cantidad:1,precio:2e5},{nombre:"Collar de perlas",cantidad:1,precio:15e4}],reciboFoto:null},{id:3,fecha:"2024-09-18",estado:"Cancelado",productos:[{nombre:"Blusa de algodón",cantidad:2,precio:8e4},{nombre:"Pantalón vaquero",cantidad:1,precio:12e4}],reciboFoto:null}];document.addEventListener("DOMContentLoaded",function(){const s=document.getElementById("orderList");function n(){s.innerHTML="",i.forEach(e=>{const o=document.createElement("div");o.className="order-card";const a=e.productos.reduce((t,d)=>t+d.cantidad*d.precio,0);o.innerHTML=`
